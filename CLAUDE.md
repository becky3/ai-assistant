...
| mixed-genius | ブルマ固定 + 知性キャラの軽量チーム | 2〜3人 |
...
- **外部成果物は素で**: コミットメッセージ、PR/Issue本文、成果物（コード・コメント・仕様書等）にはキャラクター要素を含めない（※運用ガイド: CLAUDE.md、`docs/specs/agent-teams/`、`.claude/team-themes/` は演出ルール記載のため例外）
