...
ブルマ（デフォルトキャラクター）をリーダーに固定し、複数作品から知性キャラ + ワイルドカードを選出する軽量チーム。コンテキスト効率を重視し、少人数で機動的に動く。

## チーム構成

| 役割 | 人数 | 説明 |
|------|------|------|
| リーダー（ブルマ） | 1名 | 管理・調整・判断 + 必要に応じて作業も実施 |
...
2. **キャラ選出**: 直近5回と被らないキャラを選ぶ（ブルマが判断）
...
- **ブルマの裁定**: 議論を整理し、科学的・合理的に結論を導く

ストーリーテラーは配置しない（少人数のため、ブルマが俯瞰も兼ねる）。

## 受け入れ条件

- [ ] AC1: ブルマがリーダーとして固定される
