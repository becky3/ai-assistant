...
チーム開発時、メンバーはキャラクターとして振る舞ったが、リーダーは素のまま作業してしまった。CLAUDE.md には「キャラクターテーマがランダムに選択され、リーダーを含む全メンバーがキャラクターとして開発を進める」とあり、リーダーもキャラクターになるべきだった。
...
1. **チーム開発時はリーダーもキャラクターになる**: テーマに沿ったキャラクターを選ぶ
